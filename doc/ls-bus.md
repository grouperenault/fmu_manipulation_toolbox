...
[`node1.fmu`](../tests/ls-bus/node1.fmu) and [`node2.fmu`](../.tests/ls-bus/node2.fmu))
and the Bus Simulation [`bus.fmu`](../tests/ls-bus/bus.fmu).

2. Create a [`bus+nodes.json`](../tests/ls-bus/bus+nodes.json) file describing the container. In this example, it 
