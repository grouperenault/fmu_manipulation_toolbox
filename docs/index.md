...
# ![](medias/fmu_manipulation_toolbox.png)
...
-   :material-lightbulb-on:{ .lg .middle } __Examples__
    ...
    [:octicons-arrow-right-24: View Examples](examples/common-use-cases.md)

</div>

## Overview

FMU Manipulation Toolbox is a comprehensive Python toolkit designed to **analyze, modify, and combine** [Functional Mock-up Units (FMUs)](http://fmi-standard.org/){:target="_blank"} without requiring recompilation. Built for engineers and developers working with FMI-compliant models, it provides three powerful interfaces:
...
For detailed installation instructions, platform-specific notes, and troubleshooting, see the [Installation Guide](installation.md).
...
=== "Python"
    ...
    fmu.variables = [v for v in fmu.variables if not v.name.startswith('_')]
...
!!! success "Key Benefits"
    ...
    **Production Ready**
    :   Battle-tested in automotive and industrial applications

    **Open Source**
    :   BSD-2-Clause license allows both commercial and non-commercial use

    **Well Documented**
    :   Comprehensive documentation with 50+ examples and use cases

## What's Next?

<div class="grid cards" markdown>

-   [:octicons-rocket-24: __Getting Started__](getting-started.md)
...
-   [:octicons-light-bulb-24: __Examples__](examples/common-use-cases.md)
...
- :material-source-branch: [Contribution Guidelines](help/contributing.md)
